      ...
      <div className="p-4 flex flex-col flex-1 gap-3">
        ...
        <div className="flex items-center gap-3 text-sm font-secondary text-base-content/60">
          <span className="flex items-center gap-1">
            <Bed size={14} />
            {listing.specifications?.bedroom_number} bed
          </span>
          <span className="text-base-content/30">•</span>
          <span className="flex items-center gap-1">
            <Bath size={14} />
            {listing.specifications?.bathroom_number} bath
          </span>
          <span className="text-base-content/30">•</span>
          <span className="flex items-center gap-1">
            <Users size={14} />
            {listing.specifications?.max_roommates} max
          </span>
        </div>
