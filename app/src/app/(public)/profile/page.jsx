...
export default async function ProfileEditPage() {
  ...
  const user_profile_data = {
    ...
    housing_preferences: {
      ...
      dont_mind_smoker: user.dont_mind_smoker ?? null,
      has_pet: user.has_pet ?? null,
      dont_mind_pets: user.dont_mind_pets ?? null,
      private_room: user.is_private_room_required ?? null,
      furnished: user.is_furnished_preferred ?? null,
  ...
  const available_neighborhoods = [
      ...
      'Sekimondo', 
      'Zindiro',
      'Any location close to my University'
  ];
